...
export function loginPageHtml(opts: { error?: string; returnTo?: string }): string {
  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign in · Oman Business Admin</title>
...
<form method="post" action="/admin/login">
  <h1>Oman Business Admin</h1>
  <p class="sub">Internal data operations console — authorized operators only.</p>
