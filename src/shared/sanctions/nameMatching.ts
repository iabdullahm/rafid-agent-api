...
import type { SanctionsListEntry } from "./listProviders.js";

/**
 * Conservative fuzzy company-name matching for sanctions screening. Shared by
 * oman_supplier_check and company_reputation_check (moved here from
 * src/supplier-check/sanctionsMatcher.ts, which re-exports it unchanged).
 *
...
const GENERIC_WORDS = new Set([
  ...
  // Additional common non-Gulf legal forms (added when this matcher became shared with the global
  // company_reputation_check capability). Legal-form tokens only — never distinctive words.
  "AG", "BV", "NV", "SPA", "SRL", "PTY", "LLP", "LP", "SAS", "SARL", "KG", "PVT", "PJSC", "JSC", "OJSC", "OOO", "SE", "PLLC", "KK"
]);
